namespace MDA.Core.Validators
{
    ...
    public class LesserThanDate : ValidationAttribute, IClientValidatable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the LesserThanDate class.
        /// </summary>
        /// <param name="fieldName">Field Name</param>
        /// <param name="allowEqualValues">Allow Equal Values</param>
        public LesserThanDate(string fieldName, bool allowEqualValues)
        {
            FieldName = fieldName;
