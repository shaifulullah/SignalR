namespace MDA.Security.IBLL
{
    ...
    public interface ISecurityUserRightsBll
    {
        /// <summary>
        /// Delete
        /// </summary>
        ...
        bool DeleteSecurityUserRights(int id, string userName);
        ...
        SecurityUserRights GetSecurityUserRightsForId(int id);
        ...
        IEnumerable<SecurityRightsForUserAccount> GetSecurityUserRightsList(IEnumerable<Sort> sort, LinqFilter filter, int userInCompanyInApplicationId);
        ...
        /// <returns>Interface to Model Collection Generic of the results</returns>
        IEnumerable<SecurityRightsForUserAccount> GetSecurityUserRightsListForApplicationIdAndCompanyId(int applicationId, int companyId, int userAccountId);
        ...
        /// <param name="userInCompanyInApplicationId">User In Company In Application Id</param>
        /// <returns>Interface to Model Collection Generic of the results</returns>
        DataSourceResult<SecurityRightsForUserAccount> GetSecurityUserRightsPage(int take, int skip, IEnumerable<Sort> sort, LinqFilter filter, int userInCompanyInApplicationId);
        ...
        /// <param name="userName">Username of the Person Currently Logged onto the System</param>
        /// <returns>True on Success, False on Failure</returns>
        bool InsertSecurityUserRights(SecurityUserRights securityUserRights, string userName);
        ...
        /// <param name="userName">Username of the Person Currently Logged onto the System</param>
        /// <returns>True on Success, False on Failure</returns>
        bool UpdateSecurityUserRights(SecurityUserRights securityUserRights, string userName);
    }
}